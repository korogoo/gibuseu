...
- 3일에 1번, 모든 스터디원은 온라인(디스코드)으로 발표한다
- 매 발표마다 스터디원을 2~3인 조로 랜덤 배정한다
- 발표 등록·형식 검사·일정 관리는 GitHub Issues/Actions로 자동화되어 있다
...
|---|---|---|---|---|
| 코로구 | 00:00 | 컴퓨터 구조 큰 그림: CPU, 메모리, 요청-응답 흐름 | CS / 컴퓨터 구조 | - |
